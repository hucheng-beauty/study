...
var file_stream_proto_rawDesc = []byte{
	...
	,
...
var file_stream_proto_depIdxs = []int32{
	...
	1, // 3: Greeter.GetStream:output_type -> StreamRespData
	1, // 4: Greeter.PutStream:output_type -> StreamRespData
	1, // 5: Greeter.AllStream:output_type -> StreamRespData
...
func (x *greeterGetStreamClient) Recv() (*StreamRespData, error) {
...
func (x *greeterPutStreamClient) CloseAndRecv() (*StreamRespData, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(StreamRespData)
...
func (x *greeterAllStreamClient) Recv() (*StreamRespData, error) {
	m := new(StreamRespData)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *greeterGetStreamServer) Send(m *StreamRespData) error {
...
func (x *greeterPutStreamServer) SendAndClose(m *StreamRespData) error {
	return x.ServerStream.SendMsg(m)
}
...
func (x *greeterAllStreamServer) Send(m *StreamRespData) error {
	return x.ServerStream.SendMsg(m)
}
